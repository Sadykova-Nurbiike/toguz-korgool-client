...
public class MultiIntSpecOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_int_spec_options);
    }
    ...
    public void handleChoice(View view) {
        ...
        gamePlayIntent.putExtra(getString(R.string.intent_key_type), getString(R.string.intent_val_type_multi_int_spec));
