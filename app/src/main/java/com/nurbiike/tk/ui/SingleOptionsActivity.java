...
public class SingleOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_options);
    }
    ...
    public void handleBtns(View view) {
        ...
        gamePlayIntent.putExtra(getString(R.string.intent_key_mode), getString(R.string.intent_val_mode_single));
